      ...
      <div className='flex flex-col mt-6  lg:flex-row justify-center items-center'>
        ...
        <div className='flex flex-col w-1/2 lg:w-1/3 justify-center items-center px-8'>
          ...
          <div className='mt-4 flex flex-col justify-center items-center'>
            ...
            <p className='text-[1.125em] leading-[1.35] font-bold text-[#3d3d3d] tracking-[0.2em] font-Common'>iç mimari tasarımı</p>
            <img className='my-4 w-1/4 py-2' src={img.iconInteriors} alt="" />
            <p className='text-[1.125em] leading-[1.35] font-bold text-[#3d3d3d] tracking-[0.2em] font-Common'>ofis tasarımı</p>
            <img className='my-4 w-1/4 py-2' src={img.iconPlanning} alt="" />
            <p className='text-[1.125em] leading-[1.35] font-bold text-[#3d3d3d] tracking-[0.2em] font-Common'>plan ve proje</p>
          </div>
        </div>
