...
export default function Clients() {
  ...
  return (
    <div className='w-[100%]  mx-auto flex flex-col justify-center items-center '>
      <h1 className='text-[1.0875em] lg:text-[1.6875em]  mx-auto lg:w-1/3 text-center whitespace-nowrap mt-12 font-Common tracking-[0.32em] text-[#29303e] font-semibold'>REFERAN<span className='text-[#34586e]'>SLARIMIZ</span></h1>
      ...
      {/* <div className='mt-8 text-[#fff] font-Common font-bold'>
        <button className='shadow-lg hover:shadow-none shadow-[#34586e] rounded-3xl  flex flex-row justify-center items-center px-8 py-[0.8em] transition-all ease-in-out duration-1000 bg-[#34586e] hover:bg-[#cb9c67]'>TEKLİF ALMAK İÇİN TIKLAYIN
