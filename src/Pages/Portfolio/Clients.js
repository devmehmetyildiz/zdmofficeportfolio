...
export default function Clients() {
  ...
  return (
    <div className='w-[100%]  mx-auto flex flex-col justify-center items-center '>
      <h1 className='text-[1.6875em]  mx-auto lg:w-1/3 text-center whitespace-nowrap mt-12 font-Common tracking-[0.32em] text-[#3d3d3d] font-semibold'>REFERAN<span className='text-[#c5a47e]'>SLARIMIZ</span></h1>
