     ...
     {/*  <div className='top-[44vmin] absolute left-[25vmin] flex flex-row justify-center items-center'>
      ...
      <div className='hidden md:hidden lg:visible absolute lg:left-[25%] md:left-[35%] sm:left-[45%] top-[11vmin] w-[60%] lg:flex flex-row justify-between items-center'>
        ...
        <div className=' lg:flex flex-row justify-center items-center  font-light text-[0.75em]  cursor-pointer tracking-[0.22em]'>
          <a className='cursor-pointer text-[#3d3d3d] mr-[8vmin] hover:text-[#c5a47e] font-Common' onClick={() => { history.push('/') }}>ZDM OFİS</a>
          <a className='cursor-pointer text-[#3d3d3d] mr-[8vmin] hover:text-[#c5a47e] font-Common' onClick={() => { history.push('/AboutUs') }}>BİZ KİMİZ</a>
          <a className='cursor-pointer text-[#3d3d3d] mr-[8vmin] hover:text-[#c5a47e] font-Common' onClick={() => { history.push('/Projects') }}>PROJELERİMİZ</a>
          <a className='cursor-pointer text-[#3d3d3d] mr-[8vmin] hover:text-[#c5a47e] font-Common' onClick={() => { history.push('/Products') }}>ÜRÜNLERİMİZ</a>
